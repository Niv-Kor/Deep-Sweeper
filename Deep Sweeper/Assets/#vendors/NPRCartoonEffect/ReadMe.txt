...
How to setup ?
=> Use "NPR Cartoon Effect/Cartoon" or "NPR Cartoon Effect/Cartoon No Outline" shader on your gameobject.
=> The script "NPRCartoonEffect.cs" is a helper class to control all material parameters on inspector. Let you easliy tweak effect in editor.
=> The script "Demo.cs" is used to drive the demo scene.
...
=> Shader "NPR Cartoon Effect/Cartoon Plane" used to draw colorful shadow.
=> Shader "NPR Cartoon Effect/Water" draw toony water.
...
Click play button Then you will see the cartoon shading effect.
